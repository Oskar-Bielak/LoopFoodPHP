...
<header>
    ...
    <div class="col-12 row">
        ...
        <input type="adres" class="form-control" name="adres" aria-describedby="podpowiedzadres" value="<?php echo $_SESSION['adres'] ?>">
        <small id="podpowiedzAdres" class="form-text text-muted">Adres dostawy</small>
        
        <label for="email">Podaj Miasto</label>
        <input type="miasto" class="form-control" name="miasto" aria-describedby="podpowiedzmiasto" value="<?php echo $_SESSION['miasto'] ?>">
        ...
        <input type="number" class="form-control" name="numer" aria-describedby="podpowiedznumer" value="<?php echo $_SESSION['telefon'] ?>">
